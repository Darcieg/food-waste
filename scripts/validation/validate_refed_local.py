"""
🚧 Experimental Script: Ephemeral Great Expectations Validation

This script uses an in-memory Great Expectations context with no persistent suite,
data source, or project directory. It’s intended for ad hoc validation or experimentation.

Do NOT use in production pipelines or for writing persistent suites.
"""
